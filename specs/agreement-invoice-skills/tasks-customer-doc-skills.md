...
- [x] 2. Create agreement skill claude/skills/agreement/SKILL.md <!-- id:jzl621l -->
...
- [x] 3. Create invoice skill claude/skills/invoice/SKILL.md <!-- id:jzl621m -->
...
- [x] 4. Create customer-docs-check skill claude/skills/customer-docs-check/SKILL.md <!-- id:jzl621n -->
