...
- [x] 4. Document the web-frontend JSON contract in references/json-contract.md <!-- id:96um9uk -->
  - Blocked-by: 96um9uj (Add stable transaction ids and integer pages to analyze.py --json output)

- [x] 5. Test pipeline end-to-end on synthetic AU fixture PDFs and check worked examples into references/ <!-- id:96um9ul -->
  - Blocked-by: 96um9uj (Add stable transaction ids and integer pages to analyze.py --json output)
