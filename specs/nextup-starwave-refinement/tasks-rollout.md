...
- [x] 1. Plan-only align sweep across the six consumer repos <!-- id:73v6ng1 -->
...
- [x] 2. Apply align --yes only to repos with clean working trees <!-- id:73v6ng2 -->
...
- [x] 3. Commit align changes in each applied repo; never push <!-- id:73v6ng3 -->
...
- [x] 4. Run final status report across all seven repos <!-- id:73v6ng4 -->
