...
- [x] 2. Report per-repo columns <!-- id:xdywp56 -->
...
- [x] 3. Flag drift conditions per row <!-- id:xdywp57 -->
...
- [x] 4. Guarantee the status command is read-only against target repos <!-- id:xdywp58 -->
  - Target fixture directory trees are bit-identical before and after a run
  - Blocked-by: xdywp55 (Create status script with make status target and default repo list)

## Tests

- [x] 5. Add fixture repos and unittest coverage for the status report <!-- id:xdywp59 -->
